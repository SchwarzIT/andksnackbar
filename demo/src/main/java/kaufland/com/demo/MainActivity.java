...
public class MainActivity extends AppCompatActivity {
    ...
    private Button mCreateActionTextSnackbarButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCreateActionTextSnackbarButton = findViewById(R.id.create_action_text_snackbar_button);
        ...
        mCreateActionTextSnackbarButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SnackbarManager.showSnackbar(new ActionSnackbarView.Builder()
                                                     .withBackgroundColor(R.color.colorRed)
                                                     ...
                                                     .withBoldMessageStyle()
                                                     .withMessageTextSize(10)
                                                     .withActionText("Reset")
                                                     .withActionTextColor(R.color.colorWhite)
                                                     .withBoldActionTextStyle()
                                                     .withActionListener(new ActionListener() {
                                                         @Override
                                                         public boolean onAction() {
                                                             //dismiss snackbar view
                                                     ...
                                                     .withMarginsAroundTitle(16, 16, 16, 0)
                                                     .withMarginsAroundMessage(16, 16, 16, 16)
                                                     .withMarginsAroundActionText(10, 10, 32, 10)
                                                     .withElevation(6)
                                                     .build());
            }
        });
