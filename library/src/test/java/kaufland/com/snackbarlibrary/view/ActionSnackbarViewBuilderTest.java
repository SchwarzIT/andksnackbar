...
public class ActionSnackbarViewBuilderTest {
    ...
    @Test
    public void testTextButtonMargins() {
        mDefaultSnackbarViewBuilder.withMarginsAroundActionText(10, 20, 30, 40);
        ActionSnackbarView actionSnackbarView = (ActionSnackbarView) mDefaultSnackbarViewBuilder.build();
        Assert.assertEquals(actionSnackbarView.getActionTextMarginLeft(), new Integer(10));
        Assert.assertEquals(actionSnackbarView.getActionTextMarginTop(), new Integer(20));
        Assert.assertEquals(actionSnackbarView.getActionTextMarginRight(), new Integer(30));
        Assert.assertEquals(actionSnackbarView.getActionTextMarginBottom(), new Integer(40));
    }
}